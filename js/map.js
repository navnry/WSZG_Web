...
function map_init() {
    ...
    var point = new BMap.Point(113.145816,28.18423); //地图中心点
    ...
    for (var i = 0; i < markerArr.length; i++) {
        var myIcon = new BMap.Icon('../weishi/images/base/address.png', new BMap.Size(18, 31));//这里先不用第三个参数IconOptions
        ...
        info[i] = new window.BMap.InfoWindow("<p style='font-size: 18px;'>" + markerArr[i].title + "</br>地址：" + markerArr[i].address + "</br> 电话：" + markerArr[i].tel + "</br></p>"); // 创建信息窗口对象
